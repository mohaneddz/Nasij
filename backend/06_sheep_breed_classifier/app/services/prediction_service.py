...
async def predict_from_upload(
    ...
    if len(probabilities) != len(bundle.breed_names):
        raise ValueError("Model output shape does not match configured breed labels.")
    ...
    top_items = [
        {
            "breed": bundle.breed_names[int(index)],

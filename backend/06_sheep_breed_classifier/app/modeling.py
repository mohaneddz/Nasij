...
MODEL_PATH = ARTIFACT_DIR / "sheep_breed_model.pt"
MODEL_CONFIG_PATH = ARTIFACT_DIR / "model_config.json"


class SheepModelBundle:
    def __init__(self) -> None:
        ...
        self.breed_names: list[str] = list(config["breed_names"])
        self.feature_version = str(config.get("feature_version", "resnet18"))
        ...
        self.model.fc = torch.nn.Linear(self.model.fc.in_features, len(self.breed_names))

...
import '../screens/washer_wash_queue_screen.dart';
import '../screens/washer_finished_bales_screen.dart';
import '../screens/profile_screen.dart';
import '../utils/app_theme.dart';

class WasherBottomNavBar extends StatelessWidget {
  final int currentIndex;

  const WasherBottomNavBar({super.key, required this.currentIndex});
                  ...
                  onTap: () {
                    if (currentIndex != 0) {
                      Navigator.pushReplacement(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (context, animation1, animation2) => const WasherIntakeScreen(),
                  ...
                  onTap: () {
                    if (currentIndex != 1) {
                      Navigator.pushReplacement(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (context, animation1, animation2) => const WasherWashQueueScreen(),
                          transitionDuration: Duration.zero,
                        ),
                      );
                    }
                  ...
                  onTap: () {
                    if (currentIndex != 2) {
                      Navigator.pushReplacement(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (context, animation1, animation2) => const WasherFinishedBalesScreen(),
                          transitionDuration: Duration.zero,
                        ),
                      );
                    }
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const WasherIntakeScreen()),
                );
              },
              child: Container(
                width: 60,
